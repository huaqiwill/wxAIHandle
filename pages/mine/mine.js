...
Page({
  ...
  showQrcode() {
    wx.previewImage({
      urls: ['https://wximage-1251091977.cos.ap-beijing.myqcloud.com/xai/zanCode.png'],
      current: 'https://wximage-1251091977.cos.ap-beijing.myqcloud.com/xai/zanCode.png' // 当前显示图片的http链接
    })
  },
  //第一次进页面加载
  onLoad: function () {
